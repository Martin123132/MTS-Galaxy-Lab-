(function () {
  ...
  var FRAMEWORK_PRESETS = {
    ...
    v17state: "gamma0 * leff * (1 - exp(-pow(r / leff, (((lockedRouteSingle > 0.5 && outerBulgeShare > 0.25 && pointDensity > 1.5 && midGasShare < 0.06 && outerGasShare < 0.1 && hOverRout > 0.18 && lockedUOut > 0.35)) ? 0.50 : (((lockedRouteSingle > 0.5 && memory > 5.5 && memory < 7 && fGasOut > 0.4 && fGasOut < 0.58 && outerGasShare > 0.38 && outerGasShare < 0.58 && outerBulgeShare > 0.1 && outerBulgeShare < 0.22 && innerBulgeShare > 0.45 && lockedUMax > 1.4 && lockedUMax < 2.1 && lockedUOut < 0.33 && pointDensity > 1.2 && pointDensity < 2.2 && barCurv > 0)) ? 1.85 : (((lockedRouteSingle > 0.5 && memory > 3.2 && memory < 4.4 && fGasOut > 0.2 && fGasOut < 0.35 && outerBulgeShare < 0.01 && outerDiskShare > 0.65 && outerGasShare > 0.14 && outerGasShare < 0.3 && hOverRout > 0.16 && lockedUOut > 0.34 && lockedUOut < 0.44 && lockedUMax > 1 && lockedUMax < 1.35 && pointDensity > 0.8 && pointDensity < 1.5 && barCurv < -10)) ? 2.75 : (((lockedRouteLow > 0.5 && memory > 3.4 && memory < 4.5 && fGasOut > 0.32 && fGasOut < 0.48 && midGasShare > 0.1 && midGasShare < 0.2 && outerGasShare > 0.24 && outerGasShare < 0.36 && pointDensity > 1.1 && pointDensity < 2.2 && lockedUOut > 0.33 && lockedUOut < 0.38 && barCurv < -15)) ? 1.25 : (((lockedRouteSingle > 0.5 && outerBulgeShare > 0.2 && outerBulgeShare < 0.35 && innerBulgeShare > 0.45 && memory > 9 && lockedUMax > 1.6 && lockedUOut < 0.32 && hOverRout < 0.09 && barCurv > 50 && outerGasShare > 0.2 && outerGasShare < 0.35 && pointDensity < 0.8)) ? 0.40 : (((lockedRouteSingle > 0.5 && memory > 2.4 && memory < 3 && fGasOut < 0.22 && outerGasShare < 0.16 && hOverRout > 0.28 && pointDensity < 1 && lockedUOut > 0.42)) ? 1.05 : (((lockedRouteSingle > 0.5 && outerBulgeShare > 0.55 && fGasOut < 0.08 && pointDensity > 0.8 && pointDensity < 1.2 && lockedUMax > 1 && lockedUMax < 1.3 && hOverRout > 0.1 && hOverRout < 0.16)) ? 0.75 : (((lockedRouteSingle > 0.5 && memory > 4.5 && memory < 5.4 && outerBulgeShare > 0.18 && outerBulgeShare < 0.25 && lockedUOut > 0.4 && pointDensity > 0.55 && pointDensity < 0.8 && fGasOut < 0.25 && innerBulgeShare > 0.5)) ? min(max(q + (0.83 * min(1, max(0, (lockedUMax - 3) / 2) * max(0, (lockedUOut - 0.45) / 0.08) * max(0, (0.2 - outerBulgeShare) / 0.1))) + (0.23 * min(1, max(0, (lockedUOut - 0.4) / 0.1) * max(0, (0.3 - outerBulgeShare) / 0.2) * max(0, (0.18 - hOverRout) / 0.08))) - (0.67 * min(1, max(0, (hOverRout - 0.18) / 0.08) * max(0, (pointDensity - 1.5) / 3) * max(0, (0.1 - outerGasShare) / 0.1))) - (0.27 * min(1, max(0, (lockedUMax - 1.35) / 0.6) * max(0, (0.35 - outerBulgeShare) / 0.25) * max(0, (1.8 - pointDensity) / 1.3))) - (0.22 * min(1, max(0, barCurv / 40) * max(0, (outerBulgeShare - 0.18) / 0.25) * max(0, (1.5 - pointDensity) / 1))) - (0.02 * min(1, max(0, (outerBulgeShare - 0.5) / 0.2) * max(0, (0.15 - hOverRout) / 0.07))) - (0.02 * min(1, max(0, (pointDensity - 2) / 1) * max(0, (0.18 - fGasOut) / 0.1) * max(0, (-barCurv - 15) / 20))), 0.1), 1.6) : (((lockedRouteSingle > 0.5 && memory > 4.5 && memory < 9.5 && outerBulgeShare > 0.1 && outerBulgeShare < 0.32 && pointDensity > 0.6 && pointDensity < 1.75 && fGasOut > 0.13 && fGasOut < 0.25 && lockedUOut > 0.29 && lockedUOut < 0.45 && barInnerOuter > 1.2)) ? 0.50 : (((lockedRouteSingle > 0.5 && outerBulgeShare > 0.25 && pointDensity > 1.5 && midGasShare < 0.06 && outerGasShare < 0.1 && hOverRout > 0.18 && lockedUOut > 0.35) || (lockedRouteSingle > 0.5 && outerBulgeShare > 0.4 && pointDensity > 1.5 && barCurv > 40 && lockedUMax > 1.7 && fGasOut < 0.2) || (lockedRouteSingle > 0.5 && outerBulgeShare > 0.2 && outerBulgeShare < 0.35 && innerBulgeShare > 0.45 && memory > 9 && lockedUMax > 1.6 && lockedUOut < 0.32 && hOverRout < 0.09 && barCurv > 50 && outerGasShare > 0.2 && outerGasShare < 0.35 && pointDensity < 0.8) || (lockedRouteSingle > 0.5 && outerBulgeShare > 0.55 && fGasOut < 0.08 && pointDensity > 0.8 && pointDensity < 1.2 && lockedUMax > 1 && lockedUMax < 1.3 && hOverRout > 0.1 && hOverRout < 0.16) || (lockedRouteSingle > 0.5 && memory > 7 && memory < 8.2 && outerBulgeShare > 0.18 && outerBulgeShare < 0.24 && barCurv > 30 && pointDensity > 0.45 && pointDensity < 0.6 && fGasOut < 0.25 && lockedUOut < 0.33) || (lockedRouteSingle > 0.5 && memory > 4.5 && memory < 5.4 && outerBulgeShare > 0.18 && outerBulgeShare < 0.25 && lockedUOut > 0.4 && pointDensity > 0.55 && pointDensity < 0.8 && fGasOut < 0.25 && innerBulgeShare > 0.5) || (lockedRouteSingle > 0.5 && memory > 4.5 && memory < 9.5 && outerBulgeShare > 0.1 && outerBulgeShare < 0.32 && pointDensity > 0.6 && pointDensity < 1.75 && fGasOut > 0.13 && fGasOut < 0.25 && lockedUOut > 0.29 && lockedUOut < 0.45 && barInnerOuter > 1.2) || (lockedRouteSingle > 0.5 && memory > 6.5 && memory < 7.5 && lockedUMax > 1.8 && outerBulgeShare > 0.3 && outerBulgeShare < 0.42 && innerBulgeShare > 0.75 && pointDensity > 1.2 && pointDensity < 1.6 && barCurv > 35 && fGasOut < 0.25) || (lockedRouteSingle > 0.5 && lockedUMax > 3 && lockedUOut > 0.45 && fGasOut < 0.1 && innerBulgeShare > 0.5 && outerBulgeShare > 0.1 && outerBulgeShare < 0.2 && pointDensity > 1.3) || (lockedRouteSingle > 0.5 && memory > 7.5 && memory < 8.8 && fGasOut > 0.1 && fGasOut < 0.18 && outerBulgeShare < 0.01 && pointDensity > 2 && lockedUOut > 0.33 && lockedUOut < 0.38 && barCurv < -15)) ? min(max(q + (0.83 * min(1, max(0, (lockedUMax - 3) / 2) * max(0, (lockedUOut - 0.45) / 0.08) * max(0, (0.2 - outerBulgeShare) / 0.1))) + (0.23 * min(1, max(0, (lockedUOut - 0.4) / 0.1) * max(0, (0.3 - outerBulgeShare) / 0.2) * max(0, (0.18 - hOverRout) / 0.08))) - (0.67 * min(1, max(0, (hOverRout - 0.18) / 0.08) * max(0, (pointDensity - 1.5) / 3) * max(0, (0.1 - outerGasShare) / 0.1))) - (0.27 * min(1, max(0, (lockedUMax - 1.35) / 0.6) * max(0, (0.35 - outerBulgeShare) / 0.25) * max(0, (1.8 - pointDensity) / 1.3))) - (0.22 * min(1, max(0, barCurv / 40) * max(0, (outerBulgeShare - 0.18) / 0.25) * max(0, (1.5 - pointDensity) / 1))) - (0.02 * min(1, max(0, (outerBulgeShare - 0.5) / 0.2) * max(0, (0.15 - hOverRout) / 0.07))) - (0.02 * min(1, max(0, (pointDensity - 2) / 1) * max(0, (0.18 - fGasOut) / 0.1) * max(0, (-barCurv - 15) / 20))), 0.1), 1.6) : (((lockedRouteLow > 0.5 && barCurv < -35 && hOverRout > 0.15 && lockedUMax > 0.8 && outerGasShare < 0.15 && outerBulgeShare < 0.12 && pointDensity < 1.05) || (lockedRouteLow > 0.5 && memory > 6 && hOverRout < 0.13 && lockedUOut < 0.36 && outerBulgeShare < 0.05 && pointDensity < 0.45 && barCurv < -40 && midGasShare < 0.1 && outerGasShare < 0.18 && lockedUMax < 0.75) || (lockedRouteLow > 0.5 && memory > 6 && hOverRout < 0.13 && lockedUOut < 0.36 && outerBulgeShare < 0.05 && pointDensity < 0.45 && lockedUMax > 0.74 && lockedUMax < 0.85 && outerGasShare > 0.26 && midGasShare < 0.145 && barCurv < -15)) ? min(max(0.6 - (0.17 * min(1, max(0, (hOverRout - 0.13) / 0.08))) - (0.08 * min(1, max(0, (lockedUOut - 0.35) / 0.08))) - (0.08 * min(1, max(0, (-barCurv - 30) / 30))) - (0.05 * min(1, max(0, (0.14 - outerGasShare) / 0.14))), 0.4), 0.6) : (((lockedRouteSingle > 0.5 && outerBulgeShare < 0.01 && fGasOut > 0.24 && fGasOut < 0.38 && outerGasShare > 0.18 && outerGasShare < 0.3 && barCurv < -15 && pointDensity < 1 && lockedUMax > 1.15 && hOverRout > 0.1 && lockedUOut > 0.34)) ? 0.60 : (((lockedRouteLow > 0.5 && memory > 7 && outerBulgeShare > 0.015 && outerBulgeShare < 0.08 && barCurv > 20 && hOverRout > 0.08 && hOverRout < 0.14 && fGasOut < 0.2 && pointDensity < 1.2)) ? 1.85 : (((lockedRouteSingle > 0.5 && lockedUMax > 3 && lockedUOut > 0.45 && fGasOut < 0.1 && innerBulgeShare > 0.5 && outerBulgeShare > 0.1 && outerBulgeShare < 0.2 && pointDensity > 1.3)) ? 1.6 : (((lockedRouteLow > 0.5 && memory > 5.5 && hOverRout < 0.14 && fGasOut < 0.28 && lockedUMax > 0.85 && lockedUOut < 0.39 && outerBulgeShare < 0.05 && barCurv > -20)) ? 1.4 : (((lockedRouteLow > 0.5 && memory > 1.5 && memory < 2.5 && fGasOut > 0.45 && fGasOut < 0.65 && midGasShare > 0.35 && pointDensity > 1.5 && pointDensity < 2.2 && lGapOverH < 0.75 && lockedUOut > 0.36)) ? 1.38 : (((lockedRouteLow > 0.5 && memory > 8 && hOverRout < 0.12 && fGasOut < 0.22 && lockedUOut < 0.34 && outerBulgeShare > 0.15 && pointDensity < 1.35)) ? 1.1 : (((lockedRouteLow > 0.5 && memory > 6 && hOverRout < 0.13 && fGasOut < 0.2 && lockedUOut < 0.34 && barCurv < -20 && lockedUMax < 0.85 && pointDensity > 0.8) || (lockedRouteLow > 0.5 && memory > 3.5 && memory < 5 && fGasOut < 0.08 && hOverRout > 0.2 && pointDensity < 0.65)) ? 1.25 : (((lockedRouteLow > 0.5 && memory > 2.8 && memory < 3.35 && fGasOut > 0.12 && fGasOut < 0.22 && fGasOut < 0.2 && outerGasShare < 0.18 && hOverRout > 0.24 && pointDensity > 0.9 && pointDensity < 1.3 && lockedUOut > 0.4 && barCurv < -8 && barCurv > -20) || (lockedRouteLow > 0.5 && memory > 4 && memory < 6 && fGasOut > 0.7 && lGapOverH > 3 && pointDensity > 2.5 && lockedUOut < 0.25 && lockedUMax > 0.9)) ? 1.25 : (((lockedRouteLow > 0.5 && memory > 3.4 && memory < 4.5 && fGasOut > 0.32 && fGasOut < 0.48 && midGasShare > 0.1 && midGasShare < 0.2 && outerGasShare > 0.24 && outerGasShare < 0.36 && pointDensity > 1.1 && pointDensity < 2.2 && lockedUOut > 0.33 && lockedUOut < 0.38 && barCurv < -15) || (lockedRouteLow > 0.5 && memory > 4 && memory < 4.6 && fGasOut > 0.15 && fGasOut < 0.25 && hOverRout > 0.15 && hOverRout < 0.21 && lockedUOut < 0.42 && barCurv < -30 && pointDensity > 0.9) || (lockedRouteLow > 0.5 && memory > 2 && memory < 2.6 && fGasOut > 0.44 && fGasOut < 0.7 && midGasShare > 0.24 && midGasShare < 0.35 && outerGasShare > 0.39 && outerGasShare < 0.62 && lockedUMax < 0.82 && lockedUOut > 0.33 && lockedUOut < 0.45 && hOverRout > 0.14 && pointDensity < 1.55) || (lockedRouteSingle > 0.5 && memory > 3 && memory < 3.5 && fGasOut > 0.48 && midGasShare > 0.2 && outerGasShare > 0.4 && hOverRout < 0.18 && lGapOverH > 0.55 && pointDensity > 1.2 && pointDensity < 1.8) || (lockedRouteSingle > 0.5 && memory > 7 && fGasOut < 0.12 && outerGasShare < 0.1 && outerBulgeShare < 0.01 && pointDensity > 0.7 && pointDensity < 1 && lockedUOut < 0.34)) ? 1.1 : (((lockedRouteLow > 0.5 && memory < 1.25 && fGasOut > 0.75 && midGasShare > 0.5 && outerGasShare > 0.7 && lockedUOut < 0.32 && lockedUMax > 0.85 && hOverRout < 0.22 && pointDensity < 1) || (lockedRouteLow > 0.5 && memory > 12 && fGasOut < 0.08 && hOverRout < 0.08 && outerBulgeShare > 0.05 && outerBulgeShare < 0.12 && barCurv > 0 && pointDensity < 0.45) || (lockedRouteSingle > 0.5 && memory > 2.4 && memory < 3 && fGasOut < 0.22 && outerGasShare < 0.16 && hOverRout > 0.28 && pointDensity < 1 && lockedUOut > 0.42) || (lockedRouteSingle > 0.5 && memory > 4.5 && memory < 5.4 && outerBulgeShare > 0.18 && outerBulgeShare < 0.25 && lockedUOut > 0.4 && pointDensity > 0.55 && pointDensity < 0.8 && fGasOut < 0.25 && innerBulgeShare > 0.5)) ? 1.0 : (((lockedRouteLow > 0.5 && memory > 2.4 && memory < 3.4 && fGasOut < 0.08 && outerGasShare < 0.08 && outerBulgeShare < 0.01 && hOverRout > 0.28 && lockedUOut > 0.4 && lockedUMax > 0.9 && pointDensity > 0.8 && pointDensity < 1.4 && barCurv < -10 && barMidOuter < 0.95)) ? 1.10 : (((lockedRouteSingle > 0.5 && memory > 3 && fGasOut > 0.7 && pointDensity > 2.5 && lGapOverH > 3) || (lockedRouteSingle > 0.5 && memory > 7 && memory < 8.2 && outerBulgeShare > 0.18 && outerBulgeShare < 0.24 && barCurv > 30 && pointDensity > 0.45 && pointDensity < 0.6 && fGasOut < 0.25 && lockedUOut < 0.33) || (lockedRouteSingle > 0.5 && memory > 5.5 && fGasOut > 0.25 && fGasOut < 0.65 && outerGasShare > 0.24 && pointDensity > 2.2 && outerBulgeShare < 0.01 && lockedUOut < 0.31) || (lockedRouteSingle > 0.5 && memory > 6.5 && memory < 7.5 && lockedUMax > 1.8 && outerBulgeShare > 0.3 && outerBulgeShare < 0.42 && innerBulgeShare > 0.75 && pointDensity > 1.2 && pointDensity < 1.6 && barCurv > 35 && fGasOut < 0.25)) ? 0.75 : (((lockedRouteSingle > 0.5 && pointDensity < 0.45 && outerBulgeShare > 0.08 && outerBulgeShare < 0.18 && barCurv > 10 && lockedUMax > 1 && lockedUMax < 1.4 && lockedUOut > 0.3 && lockedUOut < 0.4 && outerGasShare > 0.1 && outerGasShare < 0.35) || (lockedRouteSingle > 0.5 && memory > 4.5 && memory < 9.5 && outerBulgeShare > 0.1 && outerBulgeShare < 0.32 && pointDensity > 0.6 && pointDensity < 1.75 && fGasOut > 0.13 && fGasOut < 0.25 && lockedUOut > 0.29 && lockedUOut < 0.45 && barInnerOuter > 1.2) || (lockedRouteSingle > 0.5 && memory > 7.5 && memory < 8.2 && fGasOut > 0.3 && fGasOut < 0.45 && outerGasShare > 0.35 && outerGasShare < 0.45 && pointDensity > 1.3 && pointDensity < 1.7 && lockedUOut < 0.32 && outerBulgeShare < 0.01 && barCurv < -15)) ? 0.5 : (((lockedRouteSingle > 0.5 && barCurv < -35 && pointDensity < 0.7 && outerGasShare > 0.2 && outerBulgeShare < 0.1 && lockedUMax > 1.2)) ? 0.35 : q)))))))))))))))))))))))))))) * (((lockedRouteLow > 0.5 && memory < 1.6 && lockedUMax < 0.85 && lockedUOut > 0.39 && hOverRout > 0.14 && pointDensity < 1 && barMidOuter < 0.85 && outerBulgeShare < 0.01) || (lockedRouteLow > 0.5 && memory > 1.3 && memory < 1.8 && fGasOut > 0.7 && midGasShare > 0.4 && outerGasShare > 0.7 && lockedUMax < 0.86 && lockedUOut < 0.33 && pointDensity < 0.8 && barCurv > 0)) ? 0.25 : min(max(1, (((lockedRouteLow > 0.5 && memory > 2.4 && memory < 3.4 && fGasOut < 0.08 && outerGasShare < 0.08 && outerBulgeShare < 0.01 && hOverRout > 0.28 && lockedUOut > 0.4 && lockedUMax > 0.9 && pointDensity > 0.8 && pointDensity < 1.4 && barCurv < -10 && barMidOuter < 0.95)) ? ((x < 0.33) ? 2.0 : ((x < 0.66) ? 3.0 : 1.5)) : (((lockedRouteLow > 0.5 && memory > 3.5 && memory < 5 && fGasOut < 0.08 && hOverRout > 0.2 && pointDensity < 0.65)) ? max(min(max(1.8 + (0.3 * max(0, lockedUOut - 0.3) / 0.13) + (0.15 * max(0, -barCurv - 8) / 30) + (3.3 * max(0, memory - 6) / 4 * max(0, -barCurv - 15) / 30 * max(0, 0.13 - hOverRout) / 0.08) + (2.4 * max(0, hOverRout - 0.18) / 0.08 * max(0, 0.1 - fGasOut) / 0.1 * max(0, lockedUOut - 0.36) / 0.08) + (2.2 * max(0, lockedUMax - 0.85) / 0.15 * max(0, 0.28 - fGasOut) / 0.28 * max(0, barCurv + 22) / 25) + (0.35 * max(0, memory - 8) / 4 * max(0, outerBulgeShare - 0.12) / 0.12 * max(0, barCurv) / 25 * max(0, 0.12 - hOverRout) / 0.08) - (0.6 * max(0, barCurv) / 30) - (0.45 * max(0, outerBulgeShare - 0.05) / 0.15), 1.75), 2.55), 2.55) : (((lockedRouteLow > 0.5 && memory > 8 && hOverRout < 0.12 && fGasOut < 0.22 && lockedUOut < 0.34 && outerBulgeShare > 0.15 && pointDensity < 1.35)) ? max(min(max(1.8 + (0.3 * max(0, lockedUOut - 0.3) / 0.13) + (0.15 * max(0, -barCurv - 8) / 30) + (3.3 * max(0, memory - 6) / 4 * max(0, -barCurv - 15) / 30 * max(0, 0.13 - hOverRout) / 0.08) + (2.4 * max(0, hOverRout - 0.18) / 0.08 * max(0, 0.1 - fGasOut) / 0.1 * max(0, lockedUOut - 0.36) / 0.08) + (2.2 * max(0, lockedUMax - 0.85) / 0.15 * max(0, 0.28 - fGasOut) / 0.28 * max(0, barCurv + 22) / 25) + (0.35 * max(0, memory - 8) / 4 * max(0, outerBulgeShare - 0.12) / 0.12 * max(0, barCurv) / 25 * max(0, 0.12 - hOverRout) / 0.08) - (0.6 * max(0, barCurv) / 30) - (0.45 * max(0, outerBulgeShare - 0.05) / 0.15), 1.75), 2.55), 2.1) : (((lockedRouteLow > 0.5 && memory > 5.5 && hOverRout < 0.14 && fGasOut < 0.28 && lockedUMax > 0.85 && lockedUOut < 0.39 && outerBulgeShare < 0.05 && barCurv > -20)) ? max(min(max(1.8 + (0.3 * max(0, lockedUOut - 0.3) / 0.13) + (0.15 * max(0, -barCurv - 8) / 30) + (3.3 * max(0, memory - 6) / 4 * max(0, -barCurv - 15) / 30 * max(0, 0.13 - hOverRout) / 0.08) + (2.4 * max(0, hOverRout - 0.18) / 0.08 * max(0, 0.1 - fGasOut) / 0.1 * max(0, lockedUOut - 0.36) / 0.08) + (2.2 * max(0, lockedUMax - 0.85) / 0.15 * max(0, 0.28 - fGasOut) / 0.28 * max(0, barCurv + 22) / 25) + (0.35 * max(0, memory - 8) / 4 * max(0, outerBulgeShare - 0.12) / 0.12 * max(0, barCurv) / 25 * max(0, 0.12 - hOverRout) / 0.08) - (0.6 * max(0, barCurv) / 30) - (0.45 * max(0, outerBulgeShare - 0.05) / 0.15), 1.75), 2.55), 2.2) : (((lockedRouteSingle > 0.5 && barCurv < -35 && pointDensity < 0.7 && outerGasShare > 0.2 && outerBulgeShare < 0.1 && lockedUMax > 1.2) || (lockedRouteSingle > 0.5 && memory > 3.2 && memory < 4.4 && fGasOut > 0.2 && fGasOut < 0.35 && outerBulgeShare < 0.01 && outerDiskShare > 0.65 && outerGasShare > 0.14 && outerGasShare < 0.3 && hOverRout > 0.16 && lockedUOut > 0.34 && lockedUOut < 0.44 && lockedUMax > 1 && lockedUMax < 1.35 && pointDensity > 0.8 && pointDensity < 1.5 && barCurv < -10) || (lockedRouteSingle > 0.5 && pointDensity < 0.45 && outerBulgeShare > 0.08 && outerBulgeShare < 0.18 && barCurv > 10 && lockedUMax > 1 && lockedUMax < 1.4 && lockedUOut > 0.3 && lockedUOut < 0.4 && outerGasShare > 0.1 && outerGasShare < 0.35) || (lockedRouteSingle > 0.5 && outerBulgeShare < 0.01 && fGasOut > 0.24 && fGasOut < 0.38 && outerGasShare > 0.18 && outerGasShare < 0.3 && barCurv < -15 && pointDensity < 1 && lockedUMax > 1.15 && hOverRout > 0.1 && lockedUOut > 0.34) || (lockedRouteSingle > 0.5 && memory > 7 && fGasOut < 0.12 && outerGasShare < 0.1 && outerBulgeShare < 0.01 && pointDensity > 0.7 && pointDensity < 1 && lockedUOut < 0.34) || (lockedRouteSingle > 0.5 && memory > 2.4 && memory < 3 && fGasOut < 0.22 && outerGasShare < 0.16 && hOverRout > 0.28 && pointDensity < 1 && lockedUOut > 0.42)) ? min(max(2.25 + (0.7 * min(1, max(0, (memory - 6) / 3)) * min(1, max(0, (0.16 - fGasOut) / 0.16))) + (0.35 * max(0, hOverRout - 0.22) / 0.12) + (0.25 * max(0, -barCurv - 25) / 60) - (0.35 * max(0, outerBulgeShare) / 0.12), 1.9), 2.9) : (((lockedRouteLow > 0.5 && memory > 7 && outerBulgeShare > 0.015 && outerBulgeShare < 0.08 && barCurv > 20 && hOverRout > 0.08 && hOverRout < 0.14 && fGasOut < 0.2 && pointDensity < 1.2) || (lockedRouteLow > 0.5 && memory > 8 && hOverRout < 0.12 && fGasOut < 0.22 && lockedUOut < 0.34 && outerBulgeShare > 0.15 && pointDensity < 1.35) || (lockedRouteLow > 0.5 && memory > 6 && hOverRout < 0.13 && fGasOut < 0.2 && lockedUOut < 0.34 && barCurv < -20 && lockedUMax < 0.85 && pointDensity > 0.8) || (lockedRouteLow > 0.5 && memory > 5.5 && hOverRout < 0.14 && fGasOut < 0.28 && lockedUMax > 0.85 && lockedUOut < 0.39 && outerBulgeShare < 0.05 && barCurv > -20) || (lockedRouteLow > 0.5 && memory > 3.5 && memory < 5 && fGasOut < 0.08 && hOverRout > 0.2 && pointDensity < 0.65) || (lockedRouteLow > 0.5 && memory > 2.8 && memory < 3.35 && fGasOut > 0.12 && fGasOut < 0.22 && fGasOut < 0.2 && outerGasShare < 0.18 && hOverRout > 0.24 && pointDensity > 0.9 && pointDensity < 1.3 && lockedUOut > 0.4 && barCurv < -8 && barCurv > -20) || (lockedRouteLow > 0.5 && memory > 4 && memory < 4.6 && fGasOut > 0.15 && fGasOut < 0.25 && hOverRout > 0.15 && hOverRout < 0.21 && lockedUOut < 0.42 && barCurv < -30 && pointDensity > 0.9) || (lockedRouteLow > 0.5 && memory > 12 && fGasOut < 0.08 && hOverRout < 0.08 && outerBulgeShare > 0.05 && outerBulgeShare < 0.12 && barCurv > 0 && pointDensity < 0.45)) ? min(max(1.8 + (0.3 * max(0, lockedUOut - 0.3) / 0.13) + (0.15 * max(0, -barCurv - 8) / 30) + (3.3 * max(0, memory - 6) / 4 * max(0, -barCurv - 15) / 30 * max(0, 0.13 - hOverRout) / 0.08) + (2.4 * max(0, hOverRout - 0.18) / 0.08 * max(0, 0.1 - fGasOut) / 0.1 * max(0, lockedUOut - 0.36) / 0.08) + (2.2 * max(0, lockedUMax - 0.85) / 0.15 * max(0, 0.28 - fGasOut) / 0.28 * max(0, barCurv + 22) / 25) + (0.35 * max(0, memory - 8) / 4 * max(0, outerBulgeShare - 0.12) / 0.12 * max(0, barCurv) / 25 * max(0, 0.12 - hOverRout) / 0.08) - (0.6 * max(0, barCurv) / 30) - (0.45 * max(0, outerBulgeShare - 0.05) / 0.15), 1.75), 2.55) : (((lockedRouteSingle > 0.5 && outerBulgeShare > 0.25 && pointDensity > 1.5 && midGasShare < 0.06 && outerGasShare < 0.1 && hOverRout > 0.18 && lockedUOut > 0.35)) ? 8.0 : (((lockedRouteSingle > 0.5 && memory > 7.5 && memory < 8.8 && fGasOut > 0.1 && fGasOut < 0.18 && outerBulgeShare < 0.01 && pointDensity > 2 && lockedUOut > 0.33 && lockedUOut < 0.38 && barCurv < -15)) ? 3.25 : (((lockedRouteSingle > 0.5 && outerBulgeShare > 0.55 && fGasOut < 0.08 && pointDensity > 0.8 && pointDensity < 1.2 && lockedUMax > 1 && lockedUMax < 1.3 && hOverRout > 0.1 && hOverRout < 0.16)) ? 3.25 : (((lockedRouteSingle > 0.5 && memory > 5.5 && memory < 7 && fGasOut > 0.4 && fGasOut < 0.58 && outerGasShare > 0.38 && outerGasShare < 0.58 && outerBulgeShare > 0.1 && outerBulgeShare < 0.22 && innerBulgeShare > 0.45 && lockedUMax > 1.4 && lockedUMax < 2.1 && lockedUOut < 0.33 && pointDensity > 1.2 && pointDensity < 2.2 && barCurv > 0)) ? 1.25 : (((lockedRouteSingle > 0.5 && memory > 3.2 && memory < 4.4 && fGasOut > 0.2 && fGasOut < 0.35 && outerBulgeShare < 0.01 && outerDiskShare > 0.65 && outerGasShare > 0.14 && outerGasShare < 0.3 && hOverRout > 0.16 && lockedUOut > 0.34 && lockedUOut < 0.44 && lockedUMax > 1 && lockedUMax < 1.35 && pointDensity > 0.8 && pointDensity < 1.5 && barCurv < -10)) ? 0.5 : (((lockedRouteSingle > 0.5 && memory > 3 && fGasOut > 0.7 && pointDensity > 2.5 && lGapOverH > 3)) ? 3.5 : (((lockedRouteSingle > 0.5 && memory < 2.2 && fGasOut > 0.6 && outerGasShare > 0.55 && outerBulgeShare < 0.01 && pointDensity < 1.15 && barCurv > -10 && lockedUOut > 0.3 && hOverRout > 0.14 && lGapOverH < 1.35 && outerDiskShare > 0.34)) ? 2.5 : (((lockedRouteLow > 0.5 && memory > 3.4 && memory < 4.5 && fGasOut > 0.32 && fGasOut < 0.48 && midGasShare > 0.1 && midGasShare < 0.2 && outerGasShare > 0.24 && outerGasShare < 0.36 && pointDensity > 1.1 && pointDensity < 2.2 && lockedUOut > 0.33 && lockedUOut < 0.38 && barCurv < -15)) ? 2.4 : (((lockedRouteLow > 0.5 && memory > 2.8 && memory < 3.35 && fGasOut > 0.12 && fGasOut < 0.22 && fGasOut < 0.2 && outerGasShare < 0.18 && hOverRout > 0.24 && pointDensity > 0.9 && pointDensity < 1.3 && lockedUOut > 0.4 && barCurv < -8 && barCurv > -20)) ? 2.4 : (((lockedRouteSingle > 0.5 && pointDensity < 0.45 && outerBulgeShare > 0.08 && outerBulgeShare < 0.18 && barCurv > 10 && lockedUMax > 1 && lockedUMax < 1.4 && lockedUOut > 0.3 && lockedUOut < 0.4 && outerGasShare > 0.1 && outerGasShare < 0.35)) ? 2.2 : (((lockedRouteLow > 0.5 && barCurv < -35 && hOverRout > 0.15 && lockedUMax > 0.8 && outerGasShare < 0.15 && outerBulgeShare < 0.12 && pointDensity < 1.05)) ? min(max(1.3 + (8 * hOverRout) + (0.02 * max(0, -barCurv - 15)) + ((2 * max(0, hOverRout - 0.14)) / 0.06) - ((0.75 * max(0, outerGasShare - 0.2)) / 0.2), 1.7), 4.5) : (((lockedRouteSingle > 0.5 && barCurv < -35 && pointDensity < 0.7 && outerGasShare > 0.2 && outerBulgeShare < 0.1 && lockedUMax > 1.2)) ? min(max(2.25 + (0.7 * min(1, max(0, (memory - 6) / 3)) * min(1, max(0, (0.16 - fGasOut) / 0.16))) + (0.35 * max(0, hOverRout - 0.22) / 0.12) + (0.25 * max(0, -barCurv - 25) / 60) - (0.35 * max(0, outerBulgeShare) / 0.12), 1.9), 2.9) : (((lockedRouteLow > 0.5 && memory > 6 && hOverRout < 0.13 && lockedUOut < 0.36 && outerBulgeShare < 0.05 && pointDensity < 0.45 && barCurv < -40 && midGasShare < 0.1 && outerGasShare < 0.18 && lockedUMax < 0.75)) ? min(max(1.3 + (8 * hOverRout) + (0.02 * max(0, -barCurv - 15)) + ((2 * max(0, hOverRout - 0.14)) / 0.06) - ((0.75 * max(0, outerGasShare - 0.2)) / 0.2), 1.7), 4.5) : (((lockedRouteLow > 0.5 && memory > 6 && hOverRout < 0.13 && lockedUOut < 0.36 && outerBulgeShare < 0.05 && pointDensity < 0.45 && lockedUMax > 0.74 && lockedUMax < 0.85 && outerGasShare > 0.26 && midGasShare < 0.145 && barCurv < -15)) ? min(max(1.3 + (8 * hOverRout) + (0.02 * max(0, -barCurv - 15)) + ((2 * max(0, hOverRout - 0.14)) / 0.06) - ((0.75 * max(0, outerGasShare - 0.2)) / 0.2), 1.7), 4.5) : (((lockedRouteSingle > 0.5 && pointDensity < 0.45 && outerBulgeShare > 0.08 && outerBulgeShare < 0.18 && barCurv > 10 && lockedUMax > 1 && lockedUMax < 1.4 && lockedUOut > 0.3 && lockedUOut < 0.4 && outerGasShare > 0.1 && outerGasShare < 0.35)) ? min(max(2.25 + (0.7 * min(1, max(0, (memory - 6) / 3)) * min(1, max(0, (0.16 - fGasOut) / 0.16))) + (0.35 * max(0, hOverRout - 0.22) / 0.12) + (0.25 * max(0, -barCurv - 25) / 60) - (0.35 * max(0, outerBulgeShare) / 0.12), 1.9), 2.9) : (((lockedRouteSingle > 0.5 && outerBulgeShare > 0.25 && pointDensity > 1.5 && midGasShare < 0.06 && outerGasShare < 0.1 && hOverRout > 0.18 && lockedUOut > 0.35)) ? min(max(3.8 + (1.4 * min(1, max(0, (hOverRout - 0.18) / 0.08) * max(0, (pointDensity - 1.5) / 4) * max(0, (0.1 - outerGasShare) / 0.1) * max(0, (lockedUOut - 0.35) / 0.08))) + (0.6 * min(1, max(0, (0.08 - fGasOut) / 0.08))), 4), 5.5) : (((lockedRouteSingle > 0.5 && outerBulgeShare < 0.01 && fGasOut > 0.24 && fGasOut < 0.38 && outerGasShare > 0.18 && outerGasShare < 0.3 && barCurv < -15 && pointDensity < 1 && lockedUMax > 1.15 && hOverRout > 0.1 && lockedUOut > 0.34)) ? 1.5 : (((lockedRouteSingle > 0.5 && outerBulgeShare > 0.2 && outerBulgeShare < 0.35 && innerBulgeShare > 0.45 && memory > 9 && lockedUMax > 1.6 && lockedUOut < 0.32 && hOverRout < 0.09 && barCurv > 50 && outerGasShare > 0.2 && outerGasShare < 0.35 && pointDensity < 0.8)) ? 1.25 : (((lockedRouteSingle > 0.5 && memory < 2.2 && fGasOut > 0.6 && outerGasShare > 0.55 && outerBulgeShare < 0.01 && pointDensity < 1.15 && barCurv > -10 && lockedUOut > 0.3 && hOverRout > 0.14 && lGapOverH < 1.35 && outerDiskShare > 0.34)) ? min(max(2.2 + (0.6 * min(pointDensity, 3) / 3), 1.7), 3.5) : (((lockedRouteSingle > 0.5 && outerBulgeShare > 0.4 && pointDensity > 1.5 && barCurv > 40 && lockedUMax > 1.7 && fGasOut < 0.2)) ? 3.2 : (((lockedRouteLow > 0.5 && memory > 7 && outerBulgeShare > 0.015 && outerBulgeShare < 0.08 && barCurv > 20 && hOverRout > 0.08 && hOverRout < 0.14 && fGasOut < 0.2 && pointDensity < 1.2)) ? min(max(1.8 + (0.3 * max(0, lockedUOut - 0.3) / 0.13) + (0.15 * max(0, -barCurv - 8) / 30) + (3.3 * max(0, memory - 6) / 4 * max(0, -barCurv - 15) / 30 * max(0, 0.13 - hOverRout) / 0.08) + (2.4 * max(0, hOverRout - 0.18) / 0.08 * max(0, 0.1 - fGasOut) / 0.1 * max(0, lockedUOut - 0.36) / 0.08) + (2.2 * max(0, lockedUMax - 0.85) / 0.15 * max(0, 0.28 - fGasOut) / 0.28 * max(0, barCurv + 22) / 25) + (0.35 * max(0, memory - 8) / 4 * max(0, outerBulgeShare - 0.12) / 0.12 * max(0, barCurv) / 25 * max(0, 0.12 - hOverRout) / 0.08) - (0.6 * max(0, barCurv) / 30) - (0.45 * max(0, outerBulgeShare - 0.05) / 0.15), 1.75), 2.55) : (((lockedRouteLow > 0.5 && memory > 8 && hOverRout < 0.12 && fGasOut < 0.22 && lockedUOut < 0.34 && outerBulgeShare > 0.15 && pointDensity < 1.35)) ? max(min(max(1.8 + (0.3 * max(0, lockedUOut - 0.3) / 0.13) + (0.15 * max(0, -barCurv - 8) / 30) + (3.3 * max(0, memory - 6) / 4 * max(0, -barCurv - 15) / 30 * max(0, 0.13 - hOverRout) / 0.08) + (2.4 * max(0, hOverRout - 0.18) / 0.08 * max(0, 0.1 - fGasOut) / 0.1 * max(0, lockedUOut - 0.36) / 0.08) + (2.2 * max(0, lockedUMax - 0.85) / 0.15 * max(0, 0.28 - fGasOut) / 0.28 * max(0, barCurv + 22) / 25) + (0.35 * max(0, memory - 8) / 4 * max(0, outerBulgeShare - 0.12) / 0.12 * max(0, barCurv) / 25 * max(0, 0.12 - hOverRout) / 0.08) - (0.6 * max(0, barCurv) / 30) - (0.45 * max(0, outerBulgeShare - 0.05) / 0.15), 1.75), 2.55), 2.1) : (((lockedRouteLow > 0.5 && memory > 6 && hOverRout < 0.13 && fGasOut < 0.2 && lockedUOut < 0.34 && barCurv < -20 && lockedUMax < 0.85 && pointDensity > 0.8)) ? max(min(max(1.8 + (0.3 * max(0, lockedUOut - 0.3) / 0.13) + (0.15 * max(0, -barCurv - 8) / 30) + (3.3 * max(0, memory - 6) / 4 * max(0, -barCurv - 15) / 30 * max(0, 0.13 - hOverRout) / 0.08) + (2.4 * max(0, hOverRout - 0.18) / 0.08 * max(0, 0.1 - fGasOut) / 0.1 * max(0, lockedUOut - 0.36) / 0.08) + (2.2 * max(0, lockedUMax - 0.85) / 0.15 * max(0, 0.28 - fGasOut) / 0.28 * max(0, barCurv + 22) / 25) + (0.35 * max(0, memory - 8) / 4 * max(0, outerBulgeShare - 0.12) / 0.12 * max(0, barCurv) / 25 * max(0, 0.12 - hOverRout) / 0.08) - (0.6 * max(0, barCurv) / 30) - (0.45 * max(0, outerBulgeShare - 0.05) / 0.15), 1.75), 2.55), 2.4) : (((lockedRouteLow > 0.5 && memory > 5.5 && hOverRout < 0.14 && fGasOut < 0.28 && lockedUMax > 0.85 && lockedUOut < 0.39 && outerBulgeShare < 0.05 && barCurv > -20)) ? max(min(max(1.8 + (0.3 * max(0, lockedUOut - 0.3) / 0.13) + (0.15 * max(0, -barCurv - 8) / 30) + (3.3 * max(0, memory - 6) / 4 * max(0, -barCurv - 15) / 30 * max(0, 0.13 - hOverRout) / 0.08) + (2.4 * max(0, hOverRout - 0.18) / 0.08 * max(0, 0.1 - fGasOut) / 0.1 * max(0, lockedUOut - 0.36) / 0.08) + (2.2 * max(0, lockedUMax - 0.85) / 0.15 * max(0, 0.28 - fGasOut) / 0.28 * max(0, barCurv + 22) / 25) + (0.35 * max(0, memory - 8) / 4 * max(0, outerBulgeShare - 0.12) / 0.12 * max(0, barCurv) / 25 * max(0, 0.12 - hOverRout) / 0.08) - (0.6 * max(0, barCurv) / 30) - (0.45 * max(0, outerBulgeShare - 0.05) / 0.15), 1.75), 2.55), 2.2) : (((lockedRouteLow > 0.5 && memory > 1.5 && memory < 2.5 && fGasOut > 0.45 && fGasOut < 0.65 && midGasShare > 0.35 && pointDensity > 1.5 && pointDensity < 2.2 && lGapOverH < 0.75 && lockedUOut > 0.36)) ? 3.00 : (((lockedRouteLow > 0.5 && memory > 3.4 && memory < 4.5 && fGasOut > 0.32 && fGasOut < 0.48 && midGasShare > 0.1 && midGasShare < 0.2 && outerGasShare > 0.24 && outerGasShare < 0.36 && pointDensity > 1.1 && pointDensity < 2.2 && lockedUOut > 0.33 && lockedUOut < 0.38 && barCurv < -15)) ? 2.15 : (((lockedRouteLow > 0.5 && memory > 3.5 && memory < 5 && fGasOut < 0.08 && hOverRout > 0.2 && pointDensity < 0.65)) ? max(min(max(1.8 + (0.3 * max(0, lockedUOut - 0.3) / 0.13) + (0.15 * max(0, -barCurv - 8) / 30) + (3.3 * max(0, memory - 6) / 4 * max(0, -barCurv - 15) / 30 * max(0, 0.13 - hOverRout) / 0.08) + (2.4 * max(0, hOverRout - 0.18) / 0.08 * max(0, 0.1 - fGasOut) / 0.1 * max(0, lockedUOut - 0.36) / 0.08) + (2.2 * max(0, lockedUMax - 0.85) / 0.15 * max(0, 0.28 - fGasOut) / 0.28 * max(0, barCurv + 22) / 25) + (0.35 * max(0, memory - 8) / 4 * max(0, outerBulgeShare - 0.12) / 0.12 * max(0, barCurv) / 25 * max(0, 0.12 - hOverRout) / 0.08) - (0.6 * max(0, barCurv) / 30) - (0.45 * max(0, outerBulgeShare - 0.05) / 0.15), 1.75), 2.55), 2.5) : (((lockedRouteSingle > 0.5 && memory > 3 && fGasOut > 0.7 && pointDensity > 2.5 && lGapOverH > 3)) ? min(max(2.2 + (0.6 * min(pointDensity, 3) / 3), 1.7), 3.5) : (((lockedRouteLow > 0.5 && memory > 2.8 && memory < 3.35 && fGasOut > 0.12 && fGasOut < 0.22 && fGasOut < 0.2 && outerGasShare < 0.18 && hOverRout > 0.24 && pointDensity > 0.9 && pointDensity < 1.3 && lockedUOut > 0.4 && barCurv < -8 && barCurv > -20)) ? min(max(1.8 + (0.3 * max(0, lockedUOut - 0.3) / 0.13) + (0.15 * max(0, -barCurv - 8) / 30) + (3.3 * max(0, memory - 6) / 4 * max(0, -barCurv - 15) / 30 * max(0, 0.13 - hOverRout) / 0.08) + (2.4 * max(0, hOverRout - 0.18) / 0.08 * max(0, 0.1 - fGasOut) / 0.1 * max(0, lockedUOut - 0.36) / 0.08) + (2.2 * max(0, lockedUMax - 0.85) / 0.15 * max(0, 0.28 - fGasOut) / 0.28 * max(0, barCurv + 22) / 25) + (0.35 * max(0, memory - 8) / 4 * max(0, outerBulgeShare - 0.12) / 0.12 * max(0, barCurv) / 25 * max(0, 0.12 - hOverRout) / 0.08) - (0.6 * max(0, barCurv) / 30) - (0.45 * max(0, outerBulgeShare - 0.05) / 0.15), 1.75), 2.55) : (((lockedRouteLow > 0.5 && memory > 4 && memory < 4.6 && fGasOut > 0.15 && fGasOut < 0.25 && hOverRout > 0.15 && hOverRout < 0.21 && lockedUOut < 0.42 && barCurv < -30 && pointDensity > 0.9)) ? min(max(1.8 + (0.3 * max(0, lockedUOut - 0.3) / 0.13) + (0.15 * max(0, -barCurv - 8) / 30) + (3.3 * max(0, memory - 6) / 4 * max(0, -barCurv - 15) / 30 * max(0, 0.13 - hOverRout) / 0.08) + (2.4 * max(0, hOverRout - 0.18) / 0.08 * max(0, 0.1 - fGasOut) / 0.1 * max(0, lockedUOut - 0.36) / 0.08) + (2.2 * max(0, lockedUMax - 0.85) / 0.15 * max(0, 0.28 - fGasOut) / 0.28 * max(0, barCurv + 22) / 25) + (0.35 * max(0, memory - 8) / 4 * max(0, outerBulgeShare - 0.12) / 0.12 * max(0, barCurv) / 25 * max(0, 0.12 - hOverRout) / 0.08) - (0.6 * max(0, barCurv) / 30) - (0.45 * max(0, outerBulgeShare - 0.05) / 0.15), 1.75), 2.55) : (((lockedRouteLow > 0.5 && memory < 1.25 && fGasOut > 0.75 && midGasShare > 0.5 && outerGasShare > 0.7 && lockedUOut < 0.32 && lockedUMax > 0.85 && hOverRout < 0.22 && pointDensity < 1)) ? 1.7 : (((lockedRouteLow > 0.5 && memory > 2 && memory < 2.6 && fGasOut > 0.44 && fGasOut < 0.7 && midGasShare > 0.24 && midGasShare < 0.35 && outerGasShare > 0.39 && outerGasShare < 0.62 && lockedUMax < 0.82 && lockedUOut > 0.33 && lockedUOut < 0.45 && hOverRout > 0.14 && pointDensity < 1.55)) ? 2.1 : (((lockedRouteLow > 0.5 && memory > 12 && fGasOut < 0.08 && hOverRout < 0.08 && outerBulgeShare > 0.05 && outerBulgeShare < 0.12 && barCurv > 0 && pointDensity < 0.45)) ? min(max(1.8 + (0.3 * max(0, lockedUOut - 0.3) / 0.13) + (0.15 * max(0, -barCurv - 8) / 30) + (3.3 * max(0, memory - 6) / 4 * max(0, -barCurv - 15) / 30 * max(0, 0.13 - hOverRout) / 0.08) + (2.4 * max(0, hOverRout - 0.18) / 0.08 * max(0, 0.1 - fGasOut) / 0.1 * max(0, lockedUOut - 0.36) / 0.08) + (2.2 * max(0, lockedUMax - 0.85) / 0.15 * max(0, 0.28 - fGasOut) / 0.28 * max(0, barCurv + 22) / 25) + (0.35 * max(0, memory - 8) / 4 * max(0, outerBulgeShare - 0.12) / 0.12 * max(0, barCurv) / 25 * max(0, 0.12 - hOverRout) / 0.08) - (0.6 * max(0, barCurv) / 30) - (0.45 * max(0, outerBulgeShare - 0.05) / 0.15), 1.75), 2.55) : (((lockedRouteLow > 0.5 && memory > 4 && memory < 6 && fGasOut > 0.7 && lGapOverH > 3 && pointDensity > 2.5 && lockedUOut < 0.25 && lockedUMax > 0.9)) ? 2.4 : (((lockedRouteSingle > 0.5 && outerBulgeShare > 0.55 && fGasOut < 0.08 && pointDensity > 0.8 && pointDensity < 1.2 && lockedUMax > 1 && lockedUMax < 1.3 && hOverRout > 0.1 && hOverRout < 0.16)) ? 3.15 : (((lockedRouteSingle > 0.5 && memory > 7 && fGasOut < 0.12 && outerGasShare < 0.1 && outerBulgeShare < 0.01 && pointDensity > 0.7 && pointDensity < 1 && lockedUOut < 0.34)) ? min(max(2.25 + (0.7 * min(1, max(0, (memory - 6) / 3)) * min(1, max(0, (0.16 - fGasOut) / 0.16))) + (0.35 * max(0, hOverRout - 0.22) / 0.12) + (0.25 * max(0, -barCurv - 25) / 60) - (0.35 * max(0, outerBulgeShare) / 0.12), 1.9), 2.9) : (((lockedRouteSingle > 0.5 && memory > 7 && memory < 8.2 && outerBulgeShare > 0.18 && outerBulgeShare < 0.24 && barCurv > 30 && pointDensity > 0.45 && pointDensity < 0.6 && fGasOut < 0.25 && lockedUOut < 0.33)) ? 2.0 : (((lockedRouteSingle > 0.5 && memory > 4.5 && memory < 5.4 && outerBulgeShare > 0.18 && outerBulgeShare < 0.25 && lockedUOut > 0.4 && pointDensity > 0.55 && pointDensity < 0.8 && fGasOut < 0.25 && innerBulgeShare > 0.5)) ? 2.2 : (((lockedRouteSingle > 0.5 && memory > 4.5 && memory < 9.5 && outerBulgeShare > 0.1 && outerBulgeShare < 0.32 && pointDensity > 0.6 && pointDensity < 1.75 && fGasOut > 0.13 && fGasOut < 0.25 && lockedUOut > 0.29 && lockedUOut < 0.45 && barInnerOuter > 1.2)) ? 2.75 : (((lockedRouteSingle > 0.5 && memory > 5.5 && fGasOut > 0.25 && fGasOut < 0.65 && outerGasShare > 0.24 && pointDensity > 2.2 && outerBulgeShare < 0.01 && lockedUOut < 0.31)) ? min(max(2.2 + (0.6 * min(pointDensity, 3) / 3), 1.7), 3.5) : (((lockedRouteSingle > 0.5 && memory > 2.4 && memory < 3 && fGasOut < 0.22 && outerGasShare < 0.16 && hOverRout > 0.28 && pointDensity < 1 && lockedUOut > 0.42)) ? 2.2 : (((lockedRouteSingle > 0.5 && memory > 3 && memory < 3.5 && fGasOut > 0.48 && midGasShare > 0.2 && outerGasShare > 0.4 && hOverRout < 0.18 && lGapOverH > 0.55 && pointDensity > 1.2 && pointDensity < 1.8)) ? min(max(2.2 + (0.6 * min(pointDensity, 3) / 3), 1.7), 3.5) : (((lockedRouteSingle > 0.5 && memory > 7.5 && memory < 8.2 && fGasOut > 0.3 && fGasOut < 0.45 && outerGasShare > 0.35 && outerGasShare < 0.45 && pointDensity > 1.3 && pointDensity < 1.7 && lockedUOut < 0.32 && outerBulgeShare < 0.01 && barCurv < -15)) ? 2.0 : (((lockedRouteSingle > 0.5 && memory > 6.5 && memory < 7.5 && lockedUMax > 1.8 && outerBulgeShare > 0.3 && outerBulgeShare < 0.42 && innerBulgeShare > 0.75 && pointDensity > 1.2 && pointDensity < 1.6 && barCurv > 35 && fGasOut < 0.25)) ? 2.0 : (((lockedRouteSingle > 0.5 && lockedUMax > 3 && lockedUOut > 0.45 && fGasOut < 0.1 && innerBulgeShare > 0.5 && outerBulgeShare > 0.1 && outerBulgeShare < 0.2 && pointDensity > 1.3)) ? 2.4 : (((lockedRouteSingle > 0.5 && memory > 7.5 && memory < 8.8 && fGasOut > 0.1 && fGasOut < 0.18 && outerBulgeShare < 0.01 && pointDensity > 2 && lockedUOut > 0.33 && lockedUOut < 0.38 && barCurv < -15)) ? 2.0 : 1))))))))))))))))))))))))))))))))))))))))))))))))))))), ((lockedRouteLow > 0.5 && !((lockedRouteLow > 0.5 && barCurv < -35 && hOverRout > 0.15 && lockedUMax > 0.8 && outerGasShare < 0.15 && outerBulgeShare < 0.12 && pointDensity < 1.05) || (lockedRouteLow > 0.5 && memory > 6 && hOverRout < 0.13 && lockedUOut < 0.36 && outerBulgeShare < 0.05 && pointDensity < 0.45 && barCurv < -40 && midGasShare < 0.1 && outerGasShare < 0.18 && lockedUMax < 0.75) || (lockedRouteLow > 0.5 && memory > 6 && hOverRout < 0.13 && lockedUOut < 0.36 && outerBulgeShare < 0.05 && pointDensity < 0.45 && lockedUMax > 0.74 && lockedUMax < 0.85 && outerGasShare > 0.26 && midGasShare < 0.145 && barCurv < -15) || (lockedRouteLow > 0.5 && memory > 7 && outerBulgeShare > 0.015 && outerBulgeShare < 0.08 && barCurv > 20 && hOverRout > 0.08 && hOverRout < 0.14 && fGasOut < 0.2 && pointDensity < 1.2) || (lockedRouteLow > 0.5 && memory > 8 && hOverRout < 0.12 && fGasOut < 0.22 && lockedUOut < 0.34 && outerBulgeShare > 0.15 && pointDensity < 1.35) || (lockedRouteLow > 0.5 && memory > 6 && hOverRout < 0.13 && fGasOut < 0.2 && lockedUOut < 0.34 && barCurv < -20 && lockedUMax < 0.85 && pointDensity > 0.8) || (lockedRouteLow > 0.5 && memory > 5.5 && hOverRout < 0.14 && fGasOut < 0.28 && lockedUMax > 0.85 && lockedUOut < 0.39 && outerBulgeShare < 0.05 && barCurv > -20) || (lockedRouteLow > 0.5 && memory > 1.5 && memory < 2.5 && fGasOut > 0.45 && fGasOut < 0.65 && midGasShare > 0.35 && pointDensity > 1.5 && pointDensity < 2.2 && lGapOverH < 0.75 && lockedUOut > 0.36) || (lockedRouteLow > 0.5 && memory > 3.4 && memory < 4.5 && fGasOut > 0.32 && fGasOut < 0.48 && midGasShare > 0.1 && midGasShare < 0.2 && outerGasShare > 0.24 && outerGasShare < 0.36 && pointDensity > 1.1 && pointDensity < 2.2 && lockedUOut > 0.33 && lockedUOut < 0.38 && barCurv < -15) || (lockedRouteLow > 0.5 && memory > 3.5 && memory < 5 && fGasOut < 0.08 && hOverRout > 0.2 && pointDensity < 0.65) || (lockedRouteLow > 0.5 && memory > 2.8 && memory < 3.35 && fGasOut > 0.12 && fGasOut < 0.22 && fGasOut < 0.2 && outerGasShare < 0.18 && hOverRout > 0.24 && pointDensity > 0.9 && pointDensity < 1.3 && lockedUOut > 0.4 && barCurv < -8 && barCurv > -20) || (lockedRouteLow > 0.5 && memory > 4 && memory < 4.6 && fGasOut > 0.15 && fGasOut < 0.25 && hOverRout > 0.15 && hOverRout < 0.21 && lockedUOut < 0.42 && barCurv < -30 && pointDensity > 0.9) || (lockedRouteLow > 0.5 && memory < 1.25 && fGasOut > 0.75 && midGasShare > 0.5 && outerGasShare > 0.7 && lockedUOut < 0.32 && lockedUMax > 0.85 && hOverRout < 0.22 && pointDensity < 1) || (lockedRouteLow > 0.5 && memory > 2 && memory < 2.6 && fGasOut > 0.44 && fGasOut < 0.7 && midGasShare > 0.24 && midGasShare < 0.35 && outerGasShare > 0.39 && outerGasShare < 0.62 && lockedUMax < 0.82 && lockedUOut > 0.33 && lockedUOut < 0.45 && hOverRout > 0.14 && pointDensity < 1.55) || (lockedRouteLow > 0.5 && memory > 12 && fGasOut < 0.08 && hOverRout < 0.08 && outerBulgeShare > 0.05 && outerBulgeShare < 0.12 && barCurv > 0 && pointDensity < 0.45) || (lockedRouteLow > 0.5 && memory > 2.4 && memory < 3.4 && fGasOut < 0.08 && outerGasShare < 0.08 && outerBulgeShare < 0.01 && hOverRout > 0.28 && lockedUOut > 0.4 && lockedUMax > 0.9 && pointDensity > 0.8 && pointDensity < 1.4 && barCurv < -10 && barMidOuter < 0.95) || (lockedRouteLow > 0.5 && memory > 4 && memory < 6 && fGasOut > 0.7 && lGapOverH > 3 && pointDensity > 2.5 && lockedUOut < 0.25 && lockedUMax > 0.9)) && !((lockedRouteLow > 0.5 && memory < 1.6 && lockedUMax < 0.85 && lockedUOut > 0.39 && hOverRout > 0.14 && pointDensity < 1 && barMidOuter < 0.85 && outerBulgeShare < 0.01) || (lockedRouteLow > 0.5 && memory > 1.3 && memory < 1.8 && fGasOut > 0.7 && midGasShare > 0.4 && outerGasShare > 0.7 && lockedUMax < 0.86 && lockedUOut < 0.33 && pointDensity < 0.8 && barCurv > 0))) ? 1 : 99), (((lockedRouteSingle > 0.5 && outerBulgeShare < 0.01 && fGasOut > 0.24 && fGasOut < 0.38 && outerGasShare > 0.18 && outerGasShare < 0.3 && barCurv < -15 && pointDensity < 1 && lockedUMax > 1.15 && hOverRout > 0.1 && lockedUOut > 0.34)) ? 1.5 : 99), 99, (((lockedRouteSingle > 0.5 && memory > 3.2 && memory < 4.4 && fGasOut > 0.2 && fGasOut < 0.35 && outerBulgeShare < 0.01 && outerDiskShare > 0.65 && outerGasShare > 0.14 && outerGasShare < 0.3 && hOverRout > 0.16 && lockedUOut > 0.34 && lockedUOut < 0.44 && lockedUMax > 1 && lockedUMax < 1.35 && pointDensity > 0.8 && pointDensity < 1.5 && barCurv < -10)) ? 0.5 : 99), (((lockedRouteSingle > 0.5 && outerBulgeShare > 0.2 && outerBulgeShare < 0.35 && innerBulgeShare > 0.45 && memory > 9 && lockedUMax > 1.6 && lockedUOut < 0.32 && hOverRout < 0.09 && barCurv > 50 && outerGasShare > 0.2 && outerGasShare < 0.35 && pointDensity < 0.8)) ? 1.25 : 99), (((lockedRouteLow > 0.5 && memory > 2.4 && memory < 3.4 && fGasOut < 0.08 && outerGasShare < 0.08 && outerBulgeShare < 0.01 && hOverRout > 0.28 && lockedUOut > 0.4 && lockedUMax > 0.9 && pointDensity > 0.8 && pointDensity < 1.4 && barCurv < -10 && barMidOuter < 0.95)) ? ((x < 0.33) ? 2.0 : ((x < 0.66) ? 3.0 : 1.5)) : 99), ((outerBulgeShare > 0.35 && pointDensity < 0.4) ? 1.15 : 99), ((outerBulgeShare > 0.25 && lockedUOut > 0.39 && midGasShare < 0.1 && pointDensity < 0.8) ? 1.25 : 99)))",
    baryon: "0",
  ...
  var FRAMEWORK_PRESET_LABELS = {
    mts: "MTS baseline",
    v17state: "MTS v17.63 state-response candidate",
    baryon: "Baryon only",
